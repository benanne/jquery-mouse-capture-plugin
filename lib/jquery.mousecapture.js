 ...
 *
 * v1.1
 * - added "return this" to the mousecapture method, so it conforms to the jQuery
    ...
    $.fn.mousecapture = function(params) {
        ...
        target.each(function() {
            ...
            $this.mousedown(function(e) {
                var result = params.down.call(target, e, sharedData);
                ...
                if (params.move) {
                    moveHandler = function(e) {
                        params.move.call(target, e, sharedData);
                    };
                ...
                if (params.up) {
                    upHandler = function(e) {
                        var result = params.up.call(target, e, sharedData);
                        unbind();
                        return result;
                    };
                }
